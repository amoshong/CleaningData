...
- 'feature_all.zip': zip file of  result of step1 of run_analysis.R. subject, activity code, activity labels and all features by merging the training and the test sets.
